...
<template>
    <!-- Overlay -->
    <div v-if="show" class="h-screen fixed top-0 left-0 w-full z-40 bg-black/25"></div>

    <!-- Sidebar -->
    <aside class="fixed top-0 left-0 z-40 w-64 bg-white h-screen transition-transform sm:translate-x-0"
        :class="show ? '-translate-x-100' : '-translate-x-full'">

        <!-- Close -->
        <div v-on:click="$emit('close')" class="absolute cursor-pointer right-0 p-2 sm:hidden">
            <svg class="stroke-blue-600" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <!-- Sidebar Content -->
        <div class="flex flex-col justify-between h-full py-4 overflow-y-auto">
            <div>

                <h1 class="font-medium text-3xl text-blue-600 mt-6 mb-12 ps-11">Sales.</h1>

                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="#" class="border-l-4 border-blue-600 flex items-center py-4 ps-10 group">
                            <svg class="fill-blue-600" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <span class="ms-3 text-blue-600">Dashboard</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                            class="flex items-center py-4 ps-10 group border-l-4 border-transparent hover:border-l-4 hover:border-blue-600">
                            <svg class="stroke-gray-500 group-hover:stroke-blue-600" width="24" height="24"
                            ...
                            <span class="ms-3 text-gray-500 group-hover:text-blue-600">Lab Test</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                            ...
                            <span class="ms-3 text-gray-500 group-hover:text-blue-600">Appointment</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                            ...
                            <span class="ms-3 text-gray-500 group-hover:text-blue-600">Medicine Order</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                            ...
                            <span class="ms-3 text-gray-500 group-hover:text-blue-600">Message</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                            ...
                            <span class="ms-3 text-gray-500 group-hover:text-blue-600">Payment</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                            ...
                            <span class="ms-3 text-gray-500 group-hover:text-blue-600">Settings</span>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <a href="#"
                class="flex items-center py-4 ps-10 group border-l-4 border-transparent hover:border-l-4 hover:border-blue-600 font-medium">
                <svg class=" stroke-gray-500 group-hover:stroke-blue-600" width="24" height="24" viewBox="0 0 24 24"
                    fill="none">
                    <path
                ...
                <span class="ms-3 text-gray-500 group-hover:text-blue-600">Help</span>
            </a>
        </div>
    </aside>
</template>